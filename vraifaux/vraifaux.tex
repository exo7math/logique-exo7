...
\insertvideo{L-mGmWA-WYs}{partie 1.1. Vrai/faux, connecteurs}

\insertvideo{qafTaYAxMzY}{partie 1.2. Implication, équivalence}

\insertvideo{E-yJb-rsDNU}{partie 1.3. Formules}

\insertvideo{zHiASKr1ZRc}{partie 1.4. Connecteurs (suite)}

\insertvideo{MmhAWv6vqHA}{partie 1.5. Formules (suite)}

\insertvideo{aaCychyZFoo}{partie 1.6. Formules (fin)}
