...
On rappelle qu'une théorie est \defi{incohérente} si elle prouve n'importe quelle formule, en particulier la formule absurde \og$0=1$\fg{}, ce qui peut s'exprimer dans le langage $\mathcal{L}_0$ par $\mathcal{E}\text{st-démontrable}(\ulcorner 0=1 \urcorner)$, où on note bien sûr $1 = S(0)$. Ainsi on définit la formule :
\[
