...
Ce sont des produits finis, donc c'est une opération récursive primitive.
    ...
    \item On commence par extraire chaque code $c_i$ de $\mathcal{P}$, on compare ce code à celui de la variable $x$, si c'est le même on remplace ce symbole par le terme $n$ en utilisant la concaténation.
