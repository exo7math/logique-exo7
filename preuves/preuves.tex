...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Preuve par table de vérité}
...
\[
n >0 , \  n \text{ pair } \quad \ldoubleturn \quad n^2-1 \text{ entier naturel impair}
\]
...
\textbf{Absurde.} $\lnot \mathcal{P} \limplies \lantitauto \quad \lturn \quad \mathcal{P}$.

\textbf{Contraposée.} $\lnot \mathcal{Q} \limplies \lnot \mathcal{P} \quad \lturn \quad \mathcal{P} \limplies \mathcal{Q}$
\quad 
(ou encore $\mathcal{P} \limplies \mathcal{Q} \quad \lturn \quad \lnot \mathcal{Q} \limplies \lnot \mathcal{P}$ par double négation).
...
$
\begin{nd}
	\hypo [~] {1} {\lnot \mathcal{P} \limplies \lantitauto}  
	\have [~] {2} {\lnot \lantitauto \limplies \lnot \lnot \mathcal{P}}  \by{\text{Par contraposition}}{}
	\have [~] {3} {\ltauto \limplies \lnot \lnot \mathcal{P}} \by{\text{Car $\lnot \lantitauto = \ltauto$}}{}	
	\have [~] {4} {\ltauto \limplies \mathcal{P}} \by{\text{Car $\lnot \lnot \mathcal{P}$ donne $\mathcal{P}$}}{}	
	\have [~] {5} {\ltauto}  \by{\text{Or $\ltauto$ toujours vrai}}{}
	\have [\lturn] {6} {\mathcal{P}} \by{\text{Car $\ltauto \limplies \mathcal{P}$}}{}
\end{nd}
$
...
$
\begin{nd}
	\hypo [~] {1} {\lnot \mathcal{Q} \limplies \lnot \mathcal{P}}  
	\open
	\hypo [~] {2} {\mathcal{P}}  
	\open
	\hypo [~] {3} {\lnot \mathcal{Q}}  
	\have [~] {4} {\lnot \mathcal{P}}  \by{\text{Car $\lnot \mathcal{Q} \limplies \lnot \mathcal{P}$}}{}	
	\have [~] {5} {\lantitauto} \by{\text{Contradiction car on a $\mathcal{P}$ et $\lnot \mathcal{P}$}}{}
	\close
	\have [~] {6} {\mathcal{Q}}  \by{\text{Car on a prouvé que supposer $\lnot \mathcal{Q}$ entraîne contradiction}}{}
	\close
	\have [\lturn] {7} {\mathcal{P} \limplies \mathcal{Q}} \by{\text{Car chaque fois qu'on a $\mathcal{P}$ on a aussi $\mathcal{Q}$}}{}
\end{nd}
$
