...
Ceci n'est pas en contradiction avec le théorème de complétude car l'hypothèse $\Gamma \ldoubleturn_{\mathcal{S}} \mathcal{Q}$ n'est pas vérifiée pour toutes les structures, mais seulement pour certaines structures spécifiques ; les conditions du théorème de complétude ne sont donc pas réunies. 
...
\end{definition}
Il est équivalent de dire que $\mathcal{T}$ est non cohérente si $\mathcal{T} \ \lturn \ \lantitauto$, où $\lantitauto$ désigne une contradiction.
